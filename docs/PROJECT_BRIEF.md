        ...
        rate-limiter exists to solve a narrow, inspectable developer-tooling problem:
        Token bucket and sliding window rate limiter library for TypeScript/Node.js with zero dependencies
        ...
        Topics: nodejs, rate-limiter, sliding-window, token-bucket, typescript
